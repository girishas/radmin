...
export default class PayItForward extends Component {

render() {
      return (
	<div className="responsive-table-wrapper">
             <IntlMessages id='sidebar.payIt' defaultMessage='Chameleon | Pay It Forward'>
               {(title) => (
                 <Helmet>
            ...
            <PageTitleBar
               title={<IntlMessages id="sidebar.payIt" />}
