      ...
      let self = this;
       api.post('deleteclient',{
              ...
              const user =  users.slice(offset, offset + AppConfig.paginate);
               ...
               NotificationManager.success('Client Deleted!');
            }, 2000);
         })
         .catch(error => {
            // error hanlding
   ...
   addNewUser() {
     ...
     const { name, auth_token } = this.state.addNewUserDetail;
      ...
      if (name !== '' ) {
         ...
         api.post('addclient',newUser ).then((response) => {
            ...
            data.checked = false;
             ...
             currentCountries.unshift(data);
                setTimeout(() => {
                  ...
                  NotificationManager.success('Client Created!');
               }, 5000);       
         })
         .catch(error => {
            // error hanlding
  ...
  setArrow = (column) => {
    ...
    */
    ...
    updateUser() {
      ...
      let self = this;
      api.post('updateclient', editUser).then((response) => {
        const data =  response.data;
     ...
     if(search){
      ...
      return (
         <div className="user-management">
             <IntlMessages id='sidebar.clients' defaultMessage='Chameleon | Client Manager'>
               {(title) => (
                 <Helmet>
            ...
            <PageTitleBar
               title={<IntlMessages id="sidebar.clients" />}
               ...
               <div className="table-responsive">
                  <div className="d-flex justify-content-between py-20 px-10 border-bottom">
                     ...
                     <div>{/*
                        ...
                        <a href="javascript:void(0)" onClick={() => this.opnAddNewUserModal()} color="primary" className="caret btn-sm mr-10">{<IntlMessages id="sidebar.addnewclient" />} <i className="zmdi zmdi-plus"></i></a>
                     </div>
                  </div>
            ...
            <Modal isOpen={this.state.addNewUserModal} toggle={() => this.onAddUpdateUserModalClose()}>
               <ModalHeader toggle={() => this.onAddUpdateUserModalClose()}>
                  {editUser === null ?
                     <IntlMessages id="sidebar.addnewclient" /> : <IntlMessages id="sidebar.updateclient" />
                  }
               </ModalHeader>
               <ModalBody>
                  {editUser === null ?
