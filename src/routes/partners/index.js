   ...
   addNewUser() {
     ...
     const { name, auth_token } = this.state.addNewUserDetail;
      ...
      if (name !== '' ) {
         ...
         api.post('addpartner',newUser ).then((response) => {
            ...
            data.checked = false;
             ...
             currentCountries.unshift(data);
                setTimeout(() => {
                  ...
                  NotificationManager.success('Partner Created!');
               }, 5000);       
         })
         .catch(error => {
            // error hanlding
     ...
     if(search){
      ...
      return (
         <div className="user-management">
             <IntlMessages id='sidebar.partners' defaultMessage='Chameleon | Partner Manager'>
               {(title) => (
                 <Helmet>
            ...
            <PageTitleBar
               title={<IntlMessages id="sidebar.partners" />}
               ...
               <div className="table-responsive">
                  <div className="d-flex justify-content-between py-20 px-10 border-bottom">
                     ...
                     <div>{/*
                        ...
                        <a href="javascript:void(0)" onClick={() => this.opnAddNewUserModal()} color="primary" className="caret btn-sm mr-10">{<IntlMessages id="sidebar.addnewpartner" />} <i className="zmdi zmdi-plus"></i></a>
                     </div>
                  </div>
                  <table className="table table-middle table-hover mb-0">
                     <thead>
                        <tr>
                           ...
                           <th onClick={e => this.onSort('url')}>{<IntlMessages id="components.url" />}<i className={this.setArrow('url')}></i></th>
                                 ...
                                 <div className="media">
                                       <Media>
                                          ...
                                          {user.image !== '' && user.image !== null ?
                                             <Media object src={checkPath(foldername)+user.image} alt="User Profile 1" className="mr-20" width="40" height="40" />
            ...
            <Modal isOpen={this.state.addNewUserModal} toggle={() => this.onAddUpdateUserModalClose()}>
               <ModalHeader toggle={() => this.onAddUpdateUserModalClose()}>
                  {editUser === null ? <IntlMessages id="sidebar.addnewpartner" /> : <IntlMessages id="sidebar.updatepartner" />
                  }
               </ModalHeader>
               <ModalBody>
                  {editUser === null ?
                           ...
                           <div className="media pull-left">
                            {selectedUser.image !== '' && selectedUser.image !== null ?
                              ...
                              <div className="media-body">
                                 ...
                                 <p>{<IntlMessages id="widgets.status" />}: {selectedUser.status == 1 ?
                                    <span className={`badge badge-success badge-pill`}>Active</span> : <span className={`badge badge-danger badge-pill`}>Inactive</span>
                                 }</p>
