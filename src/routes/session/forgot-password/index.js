...
export default class Forgotpasswd extends Component {
  render() {
    return (
              ...
              <div className="col-sm-8 col-lg-5 mx-auto">
                <div className="session-body text-center">
                  ...
                  <Form>
                    ...
                    <FormGroup>
                      <Button variant="raised" className="btn-info text-white btn-block btn-large w-100">Reset Password</Button>
                    </FormGroup>
