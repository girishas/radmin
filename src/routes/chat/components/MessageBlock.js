		...
		return (
			<div className="d-flex flex-nowrap mb-3">
				...
				<div className="chat-bubble-wrap">
					...
					<span className="text-left d-block font-xs text-muted mt-1">{timeAgo(data.created_at)}</span>
				</div>
			</div>
		);
	}
	return (
		<div className="d-flex flex-nowrap flex-row-reverse mb-3">
			...
			<div className="chat-bubble-wrap">
				...
				<span className="text-right d-block font-xs text-muted mt-1">{timeAgo(data.created_at)}</span>
			</div>
		</div>
	)
};
