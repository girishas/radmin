...
class UpdateComment extends Component {
         ...
         // console.log('aks onDrrop',acceptedFiles);
            ...
            setTimeout(() => {
               ...
               $.map(this.state.multiFile, function(value, index) {
                  _this.props.onUpdateUserDetail('file_name'+index, value)
               });
            }, 100); 
   ...
   onChangeCheckbox(e) {
      ...
      if (e.target.checked) {
        ...
        this.props.onUpdateUserDetail('is_subscribed', 1);
      } else {
        // or remove the value from the unchecked checkbox from the array
        this.props.onUpdateUserDetail('is_subscribed', 0);
      }
    }
    ...
    onChangeVideoCheckbox(e) {
      ...
      if (e.target.checked) {
        // add the numerical value of the checkbox to options array
        this.props.onUpdateUserDetail('add_video', 1);
      } else {
        // or remove the value from the unchecked checkbox from the array
        this.props.onUpdateUserDetail('add_video', 0);
      }
    }
      ...
      return (
        <Form>
           ...
           {/* <Input
                    ...
                    value={this.props.user.subscription_id}
                    onChange={(e) => this.props.onUpdateUserDetail('subscription_id', e.target.value)}
                />
           <Input
                    type="hidden"
                    name="subscription_type"
                    value={this.props.user.subscription_type}
                    onChange={(e) => this.props.onUpdateUserDetail('subscription_type', e.target.value)}
                />
           <Input
                    type="hidden"
                    name="user_id"
                    value={this.props.user.user_id}
                    onChange={(e) => this.props.onUpdateUserDetail('user_id', e.target.value)}
                /> */}
            <FormGroup>
            ...
            <ReactQuill
                            ...
                            onChange={(e) => this.props.onUpdateUserDetail('description', e)}
            ...
            {/* <FormGroup check> 
               ...
               <Label check>
               <input type="checkbox" name="add_video" checked={this.props.user.add_video == 1?'true':''} value={1} onChange={this.onChangeVideoCheckbox.bind(this)} />{' '}
               <IntlMessages id="widgets.AddVideo"/>
                  
              </Label>
        </FormGroup> */}
        {this.props.user.add_video == 1 &&
            <FormGroup>
              ...
              {/* <FormGroup check> 
               ...
               <Label check>
               <input type="checkbox" name="is_subscribed" checked={this.props.user.is_subscribed == 1?'true':''} value={1} onChange={this.onChangeCheckbox.bind(this)} />{' '}
