              ...
              <a href="#" target="_blank">4 new posts</a> are added recently, click here to load them.
                            ...
                            {filteredResult && filteredResult.map((topic, key) => (
                                ...
                                <div className="tt-item mt-0"> 
                                    ...
                                    <div className="tt-col-category" style={{wordBreak:"break-all !important",padding:"10px 0 10px 0",borderRadius: "5px",backgroundColor: topic.forum_colour}}><Link to={{ pathname: '/app/forum/details' }} className="tt-color01 tt-badge" style={{ backgroundColor: "unset",whiteSpace: 'unset',color: '#fff' }} ><span>{topic.forum_name}</span></Link></div>
