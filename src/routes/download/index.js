...
render() {
      return (
	<div className="saas-dashboard responsive-table-wrapper">
             <IntlMessages id='sidebar.download' defaultMessage='Chameleon | Pay It Forward'>
               {(title) => (
                 <Helmet>
                   <title>Chameleon | {title}</title>
				   <meta name="description" content="Chameleon | Download" />
                 </Helmet>
               )}
             </IntlMessages>
            <PageTitleBar
               title={<IntlMessages id="sidebar.download" />}
