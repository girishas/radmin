...
export default class Address extends Component {
	...
	addNewAddress() {
		const { addNewAddressDetail } = this.state;
	     api.post('update-user-data', addNewAddressDetail,{
						...
						<Form>
							<div className="row">
								<div className="col-md-6">
									<FormGroup>
									<Label className="col-form-label" for="address1">{<IntlMessages id="components.street1" />}</Label>
										<Input
											type="text"
											name="street_1"
											id="address1"
											className="input-lg"
											value={addNewAddressDetail.street_1}
								...
								<div className="col-md-6">
							<FormGroup>
							<Label className="col-form-label" for="address2">{<IntlMessages id="components.street2" />}</Label>
								<Input
									type="text"
									name="street_2"
									id="address2"
									className="input-lg"
									value={addNewAddressDetail.street_2}
									onChange={(e) => this.setState({
										addNewAddressDetail: {
											...addNewAddressDetail,
								...
								<div className="col-md-6">
									<FormGroup>
									<Label className="col-form-label" for="city">{<IntlMessages id="components.city" />}</Label>
										<Input
											type="text"
											name="city"
											id="city"
								...
								<div className="col-md-6">
								<FormGroup>
									<Label className="col-form-label" for="state">{<IntlMessages id="components.state" />}</Label>
										<Input
											type="text"
											name="state"
											id="state"
								...
								<div className="col-md-6">
									<FormGroup>
							            <Label className="col-form-label" for="country">{<IntlMessages id="components.country" />}</Label>
							           <Input type="select" name="country" id="country" className="input-lg" value={addNewAddressDetail.country_id} onChange={(e) => this.setState({
												addNewAddressDetail: {
													...addNewAddressDetail,
								...
								<div className="col-md-6">
									<FormGroup>
									<Label className="col-form-label" for="zipcode">{<IntlMessages id="components.zipCode" />}</Label>
										<Input
											type="text"
											name="zip"
											id="zipcode"
											className="input-lg"
											value={addNewAddressDetail.zip}
											onChange={(e) => this.setState({
												addNewAddressDetail: {
													...addNewAddressDetail,
													zip: e.target.value
							...
							<FormGroup>
							<Label className="col-form-label" for="phone">{<IntlMessages id="components.phoneNo" />}</Label>
								<Input
									type="tel"
									name="mobile"
									id="phone"
									className="input-lg"
									value={addNewAddressDetail.mobile}
									onChange={(e) => this.setState({
										addNewAddressDetail: {
											...addNewAddressDetail,
							...
							<Button variant="raised" color="primary" className="text-white" onClick={() => this.addNewAddress()}><IntlMessages id="components.updateAddress" /></Button>
						</Form>
				</div>
