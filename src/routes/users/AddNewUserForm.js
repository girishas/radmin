...
class AddNewUserForm extends Component {
  ...
  cropImage(e) {
      ...
      this.props.addNewUserDetails.photo = this.cropper.getCroppedCanvas().toDataURL();
      this.setState({
    ...
    <Form>
        <FormGroup>
            ...
            <Input
                ...
                value={this.props.addNewUserDetails.full_name}
                onChange={(e) => this.props.onChangeAddNewUserDetails('full_name', e.target.value)}
            />
        </FormGroup>
        <FormGroup>
            ...
            <Input
                ...
                value={this.props.addNewUserDetails.email}
                onChange={(e) => this.props.onChangeAddNewUserDetails('email', e.target.value)}
            />
        </FormGroup>
        <FormGroup>
            <Label for="password">{<IntlMessages id="compenets.passwords" />}</Label>
            <Input
                type="text"
                name="password"
                id="password"
                placeholder="Enter Password"
                value={this.props.addNewUserDetails.password}
                onChange={(e) => this.props.onChangeAddNewUserDetails('password', e.target.value)}
            />
        </FormGroup>
        <FormGroup>
           ...
           <Input
                ...
                value={this.props.addNewUserDetails.mobile}
                onChange={(e) => this.props.onChangeAddNewUserDetails('mobile', e.target.value)}
            />
        </FormGroup>
        <FormGroup>
            <Label for="gender">{<IntlMessages id="widgets.gender" />}</Label>
            <Input type="select" name="gender" id="status" value={this.props.addNewUserDetails.gender} onChange={(e) => this.props.onChangeAddNewUserDetails('gender', e.target.value)}>
        ...
        <FormGroup>
            ...
            <Input type="select" name="role_id" id="role_id" value={this.props.addNewUserDetails.role_id} onChange={(e) => this.props.onChangeAddNewUserDetails('status', e.target.value)}>
        ...
        <FormGroup>
            ...
            <Input type="textarea" name="description" id="description" value={this.props.addNewUserDetails.description} onChange={(e) => this.props.onChangeAddNewUserDetails('description', e.target.value)}>
        ...
        <FormGroup>
           ...
           <Input
                ...
                value={this.props.addNewUserDetails.street_1}
                onChange={(e) => this.props.onChangeAddNewUserDetails('street_1', e.target.value)}
            />
        </FormGroup>
        <FormGroup>
           ...
           <Input
                ...
                value={this.props.addNewUserDetails.street_2}
                onChange={(e) => this.props.onChangeAddNewUserDetails('street_2', e.target.value)}
            />
        </FormGroup>
        <FormGroup>
           ...
           <Input
                ...
                value={this.props.addNewUserDetails.city}
                onChange={(e) => this.props.onChangeAddNewUserDetails('city', e.target.value)}
            />
        </FormGroup>
        <FormGroup>
           ...
           <Input
                ...
                value={this.props.addNewUserDetails.state}
                onChange={(e) => this.props.onChangeAddNewUserDetails('state', e.target.value)}
            />
        </FormGroup>
        <FormGroup>
            <Label for="country">{<IntlMessages id="components.country" />}</Label>
           <Input type="select" name="country" id="country" value={this.props.addNewUserDetails.country_id} onChange={(e) => this.props.onChangeAddNewUserDetails('country_id', e.target.value)}>
        ...
        <FormGroup>
           ...
           <Input
                ...
                value={this.props.addNewUserDetails.zip}
                onChange={(e) => this.props.onChangeAddNewUserDetails('zip', e.target.value)}
            />
        </FormGroup>
        <FormGroup>
        ...
        {this.props.addNewUserDetails.photo &&
            <Cropper
                  style={{ height: 300, width: '100%' }}
                  preview=".img-preview"
                  aspectRatio={572 / 555}
                  guides={false}
                  src={this.props.addNewUserDetails.photo}
        ...
        <FormGroup className="mt-20 mb-20 d-flex justify-space-between align-items-center">
            <div className="w-130 mb-10 mb-md-0">
               <Input type="file" name="photo" id="exampleFile" onChange={(e) => this.props.onChangeAddNewUserDetails('photo', e.target.value,e)} />
