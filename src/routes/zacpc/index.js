...
export default class Zacpc extends Component {
   ...
   render() {
      ...
      return (
         <div className="user-management">
             <IntlMessages id='sidebar.zacpc' defaultMessage='Chameleon | Zac PC'>
               {(title) => (
                 <Helmet>
                   <title>Chameleon | {title}</title>
				   <meta name="description" content="Chameleon | Zac PC" />
                 </Helmet>
               )}
             </IntlMessages>
            <PageTitleBar
               title={<IntlMessages id="sidebar.zacpc" />}
