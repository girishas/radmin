...
export const GET_RECENT_CHAT_USERS_FAILURE = 'GET_RECENT_CHAT_USERS_FAILURE';
...
// Auth Actions
export const LOGIN_USER_DB = 'LOGIN_USER_DB';
export const SIGNUP_USER_DB = 'SIGNUP_USER_DB';


export const SEND_MESSAGE_TO_USERS = 'SEND_MESSAGE_TO_USERS';
export const SEND_MESSAGE_TO_USERS_SUCCESS = 'SEND_MESSAGE_TO_USERS_SUCCESS';
export const SEND_MESSAGE_TO_USERS_FAILURE = 'SEND_MESSAGE_TO_USERS_FAILURE';
