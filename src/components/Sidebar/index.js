...
class Sidebar extends Component {
	...
	render() {
		const { enableSidebarBackgroundImage, selectedSidebarImage, isDarkSidenav, agencySidebar, user } = this.props;
				...
				>
					<div className={classNames("rct-sidebar-content", { "sidebar-overlay-dark": isDarkSidenav, 'sidebar-overlay-light': !isDarkSidenav })}>
						...
						{/* <Link to="/" className="logo-mini">
								<img src={require('Assets/img/zac_browser_logo_wt.png')} className="mr-15" alt="site logo" width="35" height="35" />
						</Link> */}
							<Link to="/" className="logo-normal">
								<img src={require('Assets/img/zac_browser_logo_wt.png')} className="img-fluid" alt="site-logo" width="154" height="80" />
							</Link>
						</div>
						<div className="rct-sidebar-wrap">
							...
							>
							 <UserBlock authUser={users} />
								{!agencySidebar ?
									<SidebarContent authUser={users} />
									:
									<AgencySidebar />
								}
							</Scrollbars>
...
const mapStateToProps = ({ settings, authUser }) => {
	...
	return { enableSidebarBackgroundImage, selectedSidebarImage, collapsedSidebar, isDarkSidenav,locale,user };
};
