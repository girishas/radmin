...
const AsyncForgotPasswordComponent = Loadable({
	loader: () => import("Routes/forgot-password"),
	loading: () => <RctPageLoader />,
});
...
// Basic Table
const AsyncBasicTablesComponent = Loadable({
	loader: () => import("Routes/content-manager/basic"),
	loading: () => <RctPageLoader />,
});

// Basic Table
const AsyncDataTablesComponent = Loadable({
	loader: () => import("Routes/content-manager/data-table"),
	loading: () => <RctPageLoader />,
});

// Responsive Table
const AsyncResponsiveTablesComponent = Loadable({
	loader: () => import("Routes/content-manager/responsive"),
	loading: () => <RctPageLoader />,
});

// PC Table
const AsyncBasicTablesComponentPc = Loadable({
	loader: () => import("Routes/content-manager/pc"),
	loading: () => <RctPageLoader />,
});
// // MAC Table
// const AsyncBasicTablesComponentMacOs = Loadable({
// 	loader: () => import("Routes/content-manager/macos"),
// 	loading: () => <RctPageLoader />,
// });
// // Linux Table
// const AsyncBasicTablesComponentLinux = Loadable({
// 	loader: () => import("Routes/content-manager/linux"),
// 	loading: () => <RctPageLoader />,
// });
// // ChromOs Table
// const AsyncBasicTablesComponentChromOs = Loadable({
// 	loader: () => import("Routes/content-manager/chromos"),
// 	loading: () => <RctPageLoader />,
// });
// // Android Table
// const AsyncBasicTablesComponentAndroid = Loadable({
// 	loader: () => import("Routes/content-manager/android"),
// 	loading: () => <RctPageLoader />,
// });
// // Box Table
// const AsyncBasicTablesComponentBox = Loadable({
// 	loader: () => import("Routes/content-manager/box"),
// 	loading: () => <RctPageLoader />,
// });
// // Ios Table
// const AsyncBasicTablesComponentIos = Loadable({
// 	loader: () => import("Routes/content-manager/ios"),
// 	loading: () => <RctPageLoader />,
// });

// Language Table
const AsyncLanguageTablesComponent = Loadable({
	loader: () => import("Routes/content-manager/language"),
	loading: () => <RctPageLoader />,
});

const AsyncUserProfile2Component = Loadable({
	loader: () => import("Routes/user/user-profile-1"),
	loading: () => <RctPageLoader />,
});


// extre for device auth
// PC Table
const AsyncDeviceAuthLogin = Loadable({
	loader: () => import("Routes/device-auth/Login"),
	loading: () => <RctPageLoader />,
});
const AsyncDeviceAuthRegister = Loadable({
	loader: () => import("Routes/device-auth/Register"),
	loading: () => <RctPageLoader />,
});
const AsyncDeviceAuthForgotPassword = Loadable({
	loader: () => import("Routes/device-auth/ForgotPassword"),
	loading: () => <RctPageLoader />,
});
export {
